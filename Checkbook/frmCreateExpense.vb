...
Public Class frmCreateExpense
    ...
    Private Sub txtCategory_TextChanged(sender As Object, e As EventArgs) Handles txtCategory.TextChanged
        ...
        If Len(txtCategory.Text) = 0 Or Len(txtMonthlyExpense.Text) = 0 Then
    ...
    Private Sub txtMonthlyExpense_TextChanged(sender As Object, e As EventArgs) Handles txtMonthlyExpense.TextChanged
        ...
        If Len(txtCategory.Text) = 0 Or Len(txtMonthlyExpense.Text) = 0 Or txtMonthlyExpense.Text = "." Then
